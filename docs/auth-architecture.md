...
- Hub pairing APIs can create one-time pairing codes only after Manager PIN approval, exchange them for long-lived local device tokens, list devices, and revoke paired devices.
